...
გაშვება (backend/ საქაღალდიდან, რადგან პროექტის დანარჩენი კოდი absolute
importებს იყენებს ამ cwd-ის დაშვებით — იხ. README):
    cd backend && python -m workflows.daily_briefing
"""
